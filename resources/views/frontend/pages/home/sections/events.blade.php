        ...
        <div class="row">
            <div class="col-sm-12 events_full_box">
                <div class="events_single">
                    <div class="event_banner">
                        <a href="#"><img src="asset/frontend/images/events/event_1.jpg" alt="" class="img-fluid"></a>
                    </div>
            ...
            <div class="col-sm-12 events_full_box">
                <div class="events_single events_single_left">
                    ...
                    <div class="event_banner">
                        <a href="#"><img src="asset/frontend/images/events/event_2.jpg" alt="" class="img-fluid"></a>
                    </div>
                    <div class="event_dete">
            ...
            <div class="col-sm-12 events_full_box">
                <div class="events_single">
                    <div class="event_banner">
                        <a href="#"><img src="asset/frontend/images/events/event_3.jpg" alt="" class="img-fluid"></a>
                    </div>
                    <div class="event_info">

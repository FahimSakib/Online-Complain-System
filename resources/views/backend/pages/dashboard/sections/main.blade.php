                                        ...
                                        <ul class="list-style-none p-0">
                                            <li class="d-flex py-1">
                                                <span><i class="fa fa-circle text-primary pr-2"></i>
                                                    ...
                                                    class="pl-2 font-weight-bold">456</span></li>
                                            <li class="d-flex py-1"><span><i class="fa fa-circle text-warning pr-2"></i>
                                                    New
                                                    Visits</span> <span class="pl-2 font-weight-bold">256</span></li>
                                            <li class="d-flex py-1"><span><i class="fa fa-circle text-info pr-2"></i>
                                                    Direct
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <p class="mb-3">Sapiente corporis fugiat, doloremque eveniet nostrum id
                                    molestiae quaerat!</p>
                    ...
                    <div class="card-body">
                        <div class="row active-task m-b-20">
                            ...
                            <div class="col-11">
                                ...
                                <h5 class="mb-0"><a href="#">Unread utf-8 in more quick overview</a>
                                </h5>
                        ...
                        <div class="row active-task m-b-20">
                            ...
                            <div class="col-11">
                                ...
                                <h5 class="mb-0"><a href="#">I get an error "No Direct Access Allowed!"
                                        when I enter purchase</a></h5>
                                <ul class="list-unstyled list-inline">
                                    <li class="list-inline-item">
                        ...
                        <div class="row active-task m-b-20">
                            ...
                            <div class="col-11">
                                ...
                                <h5 class="mb-0"><a href="#">OAuth Credentials not generating the
                                        key</a></h5>
                                <ul class="list-unstyled list-inline">
                                    <li class="list-inline-item">
                        ...
                        <div class="row active-task m-b-20">
                            ...
                            <div class="col-11">
                                ...
                                <h5 class="mb-0"><a href="#">Pre-Buy Questions : For bakery Shop (Mentor
                                        Android Application)</a></h5>
                                <ul class="list-unstyled list-inline">
                                    <li class="list-inline-item">
                        ...
                        <div class="row active-task m-b-20">
                            ...
                            <div class="col-11">
                                ...
                                <h5 class="mb-0"><a href="#">I need a payment option, for each seller
                                        per item</a></h5>
                                <ul class="list-unstyled list-inline">
                                    <li class="list-inline-item">
                        ...
                        <div class="border-bottom pb-2 pb-xxs-4">
                            <div class="row">
                                <div class="col-xxs-6 mb-3 mb-xxs-0">
                                    ...
                                    <span class="d-block"> <i class="fa fa-arrow-down text-primary"></i>
                                        <b class="text-primary">+23%</b> Vs last months </span>
                                </div>
                                <div class="col-xxs-6 mb-3 mb-xxs-0">
                                    <span class="font-17">Total cost</span>
                                    <h3 class="mt-1 mb-1">$6,456</h3>
                                    <span class="d-block"> <i class="fa fa-arrow-down text-cyan"></i> <b
                                            class="text-cyan">+65%</b> Vs last months </span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="mt-3">
                        <div class="tab nav-border-bottom">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link py-2 active show" id="home-02-tab" data-toggle="tab"
                                        href="#home-02" role="tab" aria-controls="home-02"
                                        aria-selected="true">Views</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link py-2" id="portfolio-02-tab" data-toggle="tab"
                                        href="#portfolio-02" role="tab" aria-controls="portfolio-02"
                            ...
                            <div class="col-lg-3">
                                <div id='external-events'>
                                    ...
                                    <div class='fc-event fc-event-primary' data-color="fc-event-primary"><span></span>
                                        Family
                                        Vacation</div>
                                    <div class='fc-event fc-event-warning' data-color="fc-event-warning"><span></span>
                                        Meeting In
                                        Office</div>
                                    <div class='fc-event fc-event-danger' data-color="fc-event-danger">
                                        <span></span> Client Call</div>
